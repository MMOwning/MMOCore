...
INSERT INTO `command` (`name`, `permission`, `help`) VALUES ('buffs', 195, 'Syntax: .buffs Bufft dich fuer 200G (Kann nicht im Kampf, Flug oder auf einem Mount verwendet werden)');   
...
INSERT INTO `command` (`name`, `permission`, `help`) VALUES ('gamble', 195, 'Syntax: .gamble ANZAHL_KUPFER Gluecksspiel - Ihr habt die Change Geld zu setzen und den doppelten Betrag zu gewinnen.Chance 1:1. Um z.B. 1G zu setzten gebt ihr .gamble 10000 ein');   
